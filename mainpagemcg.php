...
<head>
	...
	<link rel="stylesheet" type="text/css" href="mainpagemcg.css" />
</head>
...
<div id="Recherche" class="tabcontent">
  ...
  <br>
 <form action="keywordmcg.php" id="keywordform">
...
<div id="Ajout" class="tabcontent">
  ...
  <p>Ajouter une nouvelle personne à la table MCG</p> 
  <hr>
	<form action="add.php">
		Nom :<br>   
